...
*"Building impactful solutions through clean code, secure design, and continuous learning."*
...
I'm a **Full-Stack Software Developer** specializing in **NestJS** and **Spring Boot**, focused on building **secure, scalable, and high-performance web applications** with clean architecture and maintainable code.

- Currently deepening expertise in **advanced web security** and **modern full-stack architectures**
- Open to collaborating on **NestJS**, **Spring Boot**, **Angular**, and open-source projects
- Background in **networking**, **embedded systems**, and **Docker containerization**
- Based in **Dar es Salaam, Tanzania** · [meshackvenance7@gmail.com](mailto:meshackvenance7@gmail.com)
...
> **Note:** Stats widgets reflect public repositories only and are periodically cached. For a complete view of my work, explore the pinned repositories below.
